...
DFREF DFR_DCs=init_DC_Display()
	...
	Button DCs_b13,pos={390*SC,165*SC},size={50*SC,20*SC},title="IMG disp", proc = carpet_display, disable=1
...
//	Checkbox DCs_clck0, pos={465,87}, size={60,18}, title="reverse", value=0,disable=1
	...
	checkbox DCs_ck28,pos={465*SC,115*SC},size={60*SC,18*SC},title="x:Angle", value=1, proc=Proc_checkbox_csrctrl_dimchange, disable=1
	checkbox DCs_ck29,pos={395*SC,115*SC},size={60*SC,18*SC},title="y:Energy", value=0, proc=Proc_checkbox_csrctrl_dimchange, disable=1
	checkbox DCs_ck30,pos={530*SC,115*SC},size={40*SC,18*SC},title="auto", variable=DFR_DCs:gv_autoDCflag, proc=Proc_checkbox_Auto_Align_DC, value=0,disable=1
	SetVariable DCs_sv7, pos={575*SC,115*SC}, size={40*SC,18*SC}, value=DFR_DCs:gv_autoposition,limits={-inf,inf,0}, title=" ",labelBack=(r,g,b), disable=1,proc=Proc_setvariable_Auto_Align_DC

...
Function Open_main_Panel(ctrlName)
	...
	Variable Width = 500*Panelscale*MacScale	// screen size  in point
	...
	Button global_duplicate_panel, pos={640*SC,25*SC},size={70*SC,18*SC},title="duplicate", proc=Open_main_Panel
   ...
   listbox global_waves_list, pos={16*SC,45*SC}, size={110*SC,140*SC}, widths={200},listwave=DFR_common:w_sourceNames, selwave=DFR_common:w_sourceNamesSel, frame=2,mode=9, proc=source_Listbox_proc
	...
	//The following buttons are commented out by WSL 05/16/2021
	...
	listbox source_lb1, pos={240*SC,70*SC}, size={270*SC,110*SC},listwave=DFR_common:w_DF, widths={400},selrow=0, frame=2,mode=6, proc=source_Listbox_proc
  	...
  	checkbox source_ck1,labelBack=(r,g,b), pos={507*SC,25*SC},size={30*SC,20*SC}, title="2D", value=0,proc=Proc_checkbox_dimchange
 	checkbox source_ck2,labelBack=(r,g,b), pos={547*SC,25*SC},size={30*SC,20*SC}, title="3D", value=1,proc=Proc_checkbox_dimchange
...
//The folowing are commente out and is replaced by a new reduced list. WSL 05/16/2021
...
// The following is the reduced list. I change the number in tabLabel(n) accordingly, not sure whether it will cause problem. WSL 05/16/2021	
	TabControl main,tabLabel(1)="DCs"
	TabControl main,tabLabel(2)="Disp"
	TabControl main,tabLabel(3)="Bkg"
	TabControl main,tabLabel(4)="Norm"
	TabControl main,tabLabel(5)="proc"
